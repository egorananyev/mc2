...
grid.arrange(pTargStatMaskStat + #theme(legend.position='none') + 
             ...
             pTargDynaMaskStat + ggtitle('b: static mask, dynamic target'),
             pTargStatMaskSlow + ggtitle('c: slow mask, static target'),
             pTargDynaMaskSlow + ggtitle('d: slow mask, dynamic target'),
             pTargStatMaskFast + ggtitle('c: fast mask, static target'),
             pTargDynaMaskFast + ggtitle('d: fast mask, dynamic target'),
