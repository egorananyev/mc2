...
pStatCentNorm <- themefy(plotAve(ssAve, ylab=yLab2, yStr='norm', seStr='seNorm')) + 
    ylim(yLimNorm)
```
...
pStatPeriNorm <- themefy(plotAve(ssAve, ylab=yLab2, yStr='norm', seStr='seNorm')) +
    ylim(yLimNorm)
```
...
pDynaCentNorm <- themefy(plotAve(ssAve, ylab=yLab2, yStr='norm', seStr='seNorm')) + 
    ylim(yLimNorm)
```
...
pDynaPeriNorm <- themefy(plotAve(ssAve, ylab=yLab2, yStr='norm', seStr='seNorm')) +
    ylim(yLimNorm)
```
...
### Normalized
```{r, fig.height=4.8, fig.width=7}
grid.arrange(pStatCentNorm + ggtitle('a: static mask, central target'),
             pDynaCentNorm + ggtitle('b: dynamic mask, central target'),
             pStatPeriNorm + ggtitle('c: static mask, peripheral target'),
             pDynaPeriNorm + ggtitle('d: dynamic mask, peripheral target'),
             ncol=2, nrow=2)
```
